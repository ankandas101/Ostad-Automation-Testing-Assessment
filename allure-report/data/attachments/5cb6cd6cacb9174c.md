...
- Name: q1-locked-user.spec.js >> Q1 - Locked User Page Tests Validation >> Verify that user can see the title of this site
- Location: tests\q1-locked-user.spec.js:21:5
